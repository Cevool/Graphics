...
void VaryingsToSurfaceVertex(Varyings varyings, inout v2f_surf result)
{
    ...
    $Varyings.instanceID:  result.instanceID = varyings.instanceID;
    ...
    UNITY_TRANSFER_INSTANCE_ID(varyings, result);
...
void SurfaceVertexToVaryings(v2f_surf surfVertex, inout Varyings result)
{
    ...
    $Varyings.sh:          #endif
    $Varyings.instanceID:  #if UNITY_ANY_INSTANCING_ENABLED
    $Varyings.instanceID:  result.instanceID = surfVertex.instanceID;
    $Varyings.instanceID:  #endif
    $Varyings.lightmapUV:  #if defined(LIGHTMAP_ON)
    ...
    UNITY_TRANSFER_INSTANCE_ID(surfVertex, result);
